...
namespace Invoice.Helper
{
    public class Ean13_barcode
    {
        ...
        public Ean13_barcode()
        {

        }

        public Ean13_barcode(string mfgNumber, string productId)
        {
            this.CountryCode = "00";
        ...
        public Ean13_barcode(string countryCode, string mfgNumber, string productId)
        {
        ...
        public Ean13_barcode(string countryCode, string mfgNumber, string productId, string checkDigit)
        {
            this.CountryCode = countryCode;
            this.ManufacturerCode = mfgNumber;
            this.ProductCode = productId;
